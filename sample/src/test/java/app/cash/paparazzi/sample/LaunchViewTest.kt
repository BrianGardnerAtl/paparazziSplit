...
class LaunchViewTest {
  ...
  val paparazzi = PaparazziRule(
    paparazzi = Paparazzi(deviceConfig = PIXEL_3)
  )
  ...
  fun pixel3_differentThemes() {
    paparazzi.paparazzi.unsafeUpdateConfig(theme = "android:Theme.Material.Light")
    var launch = paparazzi.paparazzi.inflate<LinearLayout>(R.layout.launch)
    paparazzi.snapshot(view = launch, name = "light")

    paparazzi.paparazzi.unsafeUpdateConfig(theme = "android:Theme.Material.Light.NoActionBar")
    launch = paparazzi.paparazzi.inflate(R.layout.launch)
    paparazzi.snapshot(view = launch, name = "light no_action_bar")
  }

  @Test
  fun nexus5_differentOrientations() {
    paparazzi.paparazzi.unsafeUpdateConfig(deviceConfig = NEXUS_5)
    var launch = paparazzi.paparazzi.inflate<LinearLayout>(R.layout.launch)
    paparazzi.snapshot(launch, "portrait")

    paparazzi.paparazzi.unsafeUpdateConfig(deviceConfig = NEXUS_5_LAND)
    launch = paparazzi.paparazzi.inflate(R.layout.launch)
